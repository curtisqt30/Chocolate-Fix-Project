...
function load_hint(level){
	...
	case 3:
		...
		// Set hint 2 pieces
		global.hint2 = [
			[spr_hint_orange_square, 130, 450], // pos 1
			[spr_hint_orange_triangle, 199, 450], // pos 2
			[undefined, 268, 450], // pos 3
			[spr_hint_orange_circle, 130, 519], // pos 4 
			[spr_hint_yellow_square, 199, 519], // pos 5
			[undefined, 268, 519], // pos 6 
			[undefined, 130, 588], // pos 7
			[undefined, 199, 588], // pos 8
			[undefined, 268, 588], // pos 9
	...
	case 8:
		// Clear template
		global.hint_shape_1 = 17;
			//  [ ][ ][ ]
			//  [x][ ][x]
			//  [ ][x][ ]
		global.hint_shape_2 = 18;
			//  [ ][ ][x]
			//  [ ][x][x]
			//  [ ][x][ ]
		global.hint_shape_3 = 19;  
			//  [ ][ ][x]
			//  [ ][x][x]
			//  [ ][ ][x]
		...
		global.hint1 = [
			...
			[undefined, 199, 219], // pos 5
			[spr_hint_orange_circle, 268, 219], // pos 6 
			[undefined, 130, 288], // pos 7
			[spr_hint_square, 199, 288], // pos 8
			[undefined, 268, 288], // pos 9
		]
		// Set hint 2 pieces
		global.hint2 = [
			[undefined, 130, 450], // pos 1
			[undefined, 199, 450], // pos 2
			[spr_hint_circle, 268, 450], // pos 3
			[undefined, 130, 519], // pos 4 
			[spr_hint_circle, 199, 519], // pos 5
			[spr_hint_pink, 268, 519], // pos 6 
			[undefined, 130, 588], // pos 7
			[spr_hint_yellow_square, 199, 588], // pos 8
			[undefined, 268, 588], // pos 9
		]
		// Set hint 3 pieces
		global.hint3 = [
			[undefined, 130, 750], // pos 1
			[undefined, 199, 750], // pos 2
			[spr_hint_pink_triangle, 268, 750], // pos 3
			[undefined, 130, 819], // pos 4
			[spr_hint_square, 199, 819], // pos 5
			[undefined, 268, 819], // pos 6
			[undefined, 130, 888], // pos 7
			[undefined, 199, 888], // pos 8
			[spr_hint_orange, 268, 888], // pos 9
		]
		break;
	default:
		// Clear template
