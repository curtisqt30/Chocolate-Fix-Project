...
// takes a variable instead of the direct sprite
draw_sprite(spr_blue_circle_small, 0, 130, 150); // Grid position 1  
draw_sprite(spr_blue_diamond_small, 0, 199, 150); // Grid position 2
draw_sprite(spr_blue_diamond_small, 0, 268, 150); // Grid position 3
draw_sprite(spr_blue_diamond_small, 0, 130, 219); // Grid position 4
draw_sprite(spr_blue_diamond_small, 0, 199, 219); // Grid position 5
draw_sprite(spr_blue_diamond_small, 0, 268, 219); // Grid position 6
draw_sprite(spr_blue_diamond_small, 0, 130, 288); // Grid position 7
draw_sprite(spr_blue_diamond_small, 0, 199, 288); // Grid position 8
draw_sprite(spr_blue_star_small, 0, 268, 288); // Grid position 9
